...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/forgot-password (1).png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/forgot-password (2).png"))); // NOI18N
    ...
    private void SubmitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitbtnActionPerformed
        if(jTextField1.getText().equals("")){
            ...
            boolean b = service.ForgotPasswordService.changePassword(jTextField1.getText(),jPasswordField1.getText(),jTextField2.getText());
            if(b){
